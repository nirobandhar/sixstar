...
class Sales extends CI_Controller {
	...
	function installmentrpt(){
			...
			$data['content'] = $this->load->view('sales/monthlyreportforins', $data, TRUE);
			$this->load->view('index', $data);
		}
	function installmentrecord(){
		$data['cmonth']=$this->input->post('Purchase_date');
		$this->load->view('sales/detailsinstallment',$data);
		}
	function monthlysummery(){
			$data['title'] = "Monthly Summery Sheet";
			$data['content'] = $this->load->view('sales/monthlysummery', $data, TRUE);
			$this->load->view('index', $data);
		}
	function monthlyrecord(){
		$data['cmonth']=$this->input->post('Purchase_date');
		$this->load->view('sales/monthlysummeryresult',$data);
		}
	function lossprofit(){
			$data['title'] = "Loss Profit Calculation";
			$data['content'] = $this->load->view('sales/lossprofitsummery', $data, TRUE);
			$this->load->view('index', $data);
		}
