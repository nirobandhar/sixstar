...
class Purchase extends CI_Controller {
   ...
   public function Purchase_order(){
        ...
        $Purchase = array(
            ...
            "PurchaseMaster_LabourCost"         =>$this->input->post('labourCost'),
        ...
        $this->load->view('Administrator/purchase/purchase_order');
    ...
    public function purchase_invoice_search()  {
        ...
        $this->load->view('Administrator/purchase/purchase_invoice_search', $datas);
    ...
    function damage_select_product()  {
        ...
        $this->load->view('Administrator/purchase/show_damage_pro_name', $data);
    ...
    function damage_product_insert()  {
        ...
        $this->load->view('Administrator/purchase/damage_entry');
    ...
    public function returns_list()  {
        ...
        $data['content'] = $this->load->view('Administrator/purchase/return_list', $data, TRUE);
