...
//Customer Details facncybox end
    ...
    public function insert_category()  {
        ...
        if($query->num_rows() > 0){
            ...
            $this->load->view('Administrator/ajax/add_prodcategory');    
        }
    }
    ...
    public function add_size()  {
        ...
        $data['content'] = $this->load->view('Administrator/add_prodsize', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
    public function insert_size()  {
        ...
        if($query->num_rows() > 0){
            ...
            $this->load->view('Administrator/ajax/add_prodsize', $data);
        }
        else{
            $data = array(
            ...
            $this->load->view('Administrator/ajax/add_prodsize');    
        }
    }
    ...
    public function insert_unit()  {
        ...
        if($query->num_rows() > 0){
            $data['exists'] = "This Name is Already Exists";
            $this->load->view('Administrator/ajax/unit', $data);
        }
        else{
            $data = array(
            ...
            $this->load->view('Administrator/ajax/unit');
        }
    }
    ...
    public function unitupdate(){
        ...
        $fld = 'Unit_SlNo';
            ...
            redirect("Administrator/page/unit");  
    } 
    ...
    public function district()  {
        ...
        $data['content'] = $this->load->view('Administrator/district', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
    public function insert_district()  {
        ...
        if($query->num_rows() > 0){
            $data['exists'] = "This Name is Already Exists";
            $this->load->view('Administrator/ajax/district',$data);
        }
        else{
            $data = array(
    ...
    public function company_profile_Update(){
        ...
        $id = '1';
        $data['selected'] = $this->mt->select_by_id('tbl_company', $id,$fld);
        $this->load->view('Administrator/ajax/company',$data);
    }
    //^^^^^^^^^^^^^^^^^^^^^
    // Brunch Name
    ...
    public function insert_brunch()  {
        ...
        if($query->num_rows() > 0){
           ...
           /* $branchData = array(
            ...
            $this->load->view('Administrator/ajax/brunch');
        }
