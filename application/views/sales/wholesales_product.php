                        ...
                        <tr style="height:150px" >
                            <td align="center">
                                ...
                                <input type="text" id="Prounit" readonly style="border:none;font-size:12px;width:20px"><br/><br/>
                                 ...
                                 <input type="text" id="purate" readonly style="border:none;font-size:20px;width:78px;text-align:center;color:green">
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <tr>
                <td width="40%" >
                    <fieldset style="height:135px">
                        <legend>Notes</legend>
                        <textarea name="SelesNotes" id="SelesNotes" rows="4" style="width:100%"></textarea>
                    </fieldset>
                </td>
                <td width="60%">
...
<script type="text/javascript">
    ...
    function Products()   {
        ...
        var urldata = "<?php echo base_url(); ?>wholesales/SelectProducts";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
...
<script type="text/javascript">
    function SalseToCart(){
        ...
        var inputdata = 'packagename='+packagename+'&salesInvoiceno='+salesInvoiceno+'&sales_date='+sales_date+'&customerID='+customerID+'&SelesNotes='+SelesNotes+'&subTotal='+subTotal+'&vatPersent='+vatPersent+'&SellsFreight='+SellsFreight+'&SellsDiscount='+SellsDiscount+'&SellTotals='+SellTotals+'&SellsPaid='+SellsPaid+'&SellsDue='+SellsDue+'&status='+2;
        var urldata = "<?php echo base_url(); ?>wholesales/sales_order/";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
