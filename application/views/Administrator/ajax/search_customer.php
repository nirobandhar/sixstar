...
<div class="row_section clearfix" style="margin-top:20px;padding-bottom:0px;">
    ...
    <div class="clearfix moderntabs" style="width:330px;width:90%;">
        ...
        <table class="zebra" cellspacing="0" cellpadding="0" border="0" id="" style="text-align:left;width:100%;border-collapse:collapse;">
            <tbody>
            <?php $sql = mysql_query("SELECT * FROM tbl_customer WHERE Customer_Code LIKE '%$Searchkey%' or Customer_Name LIKE '%$Searchkey%' or Customer_Address LIKE '%$Searchkey%' or Customer_Mobile LIKE '%$Searchkey%' order by Customer_Code asc");
            while($row = mysql_fetch_array($sql)){ ?>
                <tr>
