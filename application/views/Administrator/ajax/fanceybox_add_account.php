                    ...
                    <div id="success"></div>  
                        <div class="body">
                            <div class="full clearfix">
                                ...
                                <div class="left">                                    
                                    <input name="supplier_id" type="text" id="lier_id" class="required" disabled="" style="width:263px" value="<?php   $serial ="A1000"; $sql = mysql_query("SELECT * FROM tbl_account");
...
<script type="text/javascript">
    function Submit(){
        ...
        var urldata = "<?php echo base_url();?>Administrator/account/account_insertFanceybox";
        var succes = "";
        if(succes == ""){
            var inputdata = 'account_id='+account_id+'&accountName='+accountName+'&accounttype='+accounttype+'&Description='+Description;
            var urldata = "<?php echo base_url();?>Administrator/account/account_insertFanceybox";
