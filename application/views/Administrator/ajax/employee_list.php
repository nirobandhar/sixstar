            ...
            while($row = mysql_fetch_array($sql)){ ?>
                ...
                <tr>
                    ...
                    <td style="width:90px">
                        ...
                        <a href="<?php echo base_url().'Administrator/employee/employee_edit/'.$row['Employee_SlNo'];?>" style="color:green;font-size:20px;float:left; margin-right:20px;" title="Eidt" onclick="return confirm('Are you sure you want to edit this item?');"><i class="fa fa-pencil"></i></a>
