                ...
                <tr>
                   ...
                   <td> 
                        <div class="side-by-side clearfix">
                            <div>
                                  <select id="purchasemsid" data-placeholder="Choose an Invoice..." class="chosen-select" style="width:200px;" tabindex="2" onchange="Supplier()">
                                        <option value=""></option>
                                        <?php $sql = mysql_query("SELECT * FROM tbl_purchasemaster order by PurchaseMaster_InvoiceNo desc");
...
<script type="text/javascript">
  function searchforreturn(){
    ...
    var urldata = "<?php echo base_url();?>Administrator/purchase/purchase_invoice_search";
    $.ajax({
        type: "POST",
        url: urldata,
        data: inputData,
