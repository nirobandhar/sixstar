                        ...
                        <div class="side-by-side clearfix">
                            <div>
                                <select id="invoiceno" data-placeholder="Choose a Product..." class="chosen-select" style="width:250px;" tabindex="2" >
                                     <option value=""></option>
                                    <?php $sql = mysql_query("SELECT * FROM tbl_purchasemaster  Where PurchaseMaster_BranchID='".$this->brunch."' order by PurchaseMaster_InvoiceNo desc");
...
<script type="text/javascript">
    function searchforreturn(){
        ...
        var urldata = "<?php echo base_url();?>Administrator/purchase/PurchasereturnSearch";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputData,
