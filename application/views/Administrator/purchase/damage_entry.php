                    ...
                    <div class="body">
                        ...
                        <div class="full clearfix">
                            <span>Product Name</span>  
                                <select id="prod_id" class="required" style="width:235px" onchange="Products_select()">
                        ...
                        <div class="full clearfix">
                            ...
                            <div class="left"> 
                            <textarea name="desc" id="desc" class="required" placeholder="" autofocus="" cols="27" rows="3"></textarea>                                     
                            </div>
                        </div> 
                        <div class="full clearfix">
                            <span></span>
...
function calamount(){
    ...
    function Products_select()   {
        ...
        var urldata = "<?php echo base_url();?>Administrator/purchase/damage_select_product";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
    ...
    function DamageProducts()   {
        ...
        var urldata = "<?php echo base_url();?>Administrator/purchase/damage_product_insert";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
