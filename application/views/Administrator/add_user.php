            ...
            <div class="content_scroll">
                ...
                <div id="page_menu" class="page_menu">
                    ...
                    <h1 class="users"><i></i><span>Add User</span> 
                                        ...
                                        <div class="section_content">
                                            ...
                                            <div class="section_full clearfix">
                                                ...
                                                <div class="section_full">
                                                    ...
                                                    <input name="txtFirstName" type="text" id="txtFirstName" class="txt"  />
...
<!--                     <div class="section_left">
                        ...
                        <select name="Brunch" id="Brunch" class="txt" required>                                           <option value=""></option>                                    <?php $sql = mysql_query("SELECT * FROM tbl_brunch order by Brunch_name asc ");                                            while($row = mysql_fetch_array($sql)){ ?>
                                     ...
                                     <div class="row_section clearfix">
                                        ...
                                        <div class="section_content">
                                            ...
                                            <div class="section_right clearfix">
                                               ...
                                               <a  class="button btn-info"  href="<?php echo base_url();?>Administrator/user_management">Cancel</a>
...
<script type="text/javascript">
    ...
    function submit(){
        ...
        var inputdata = 'username='+username+'&rePassword='+rePassword+'&txtFirstName='+txtFirstName+'&Brunch='+Brunch+'&type='+type;

        var urldata = "<?php echo base_url();?>Administrator/user_management/user_Insert";
