<div class="content_scroll" style="padding:101px 20px 25px 155px">
    ...
    <table width="70%" align="center">
    	...
    	<tr><td colspan="3">
        <p style="text-align: center;"><img src="<?php echo base_url('images/logo.png'); ?>" alt=" Six Star Electronics & Furniture"></p>
        <h1 style="text-align:center;font-size:30px;color:#ccc;">
        <!-- <img src="" alt=" Six Star Electronics & Furniture"> -->
        Six Star Electronics & Furniture
        </h1> 
    	...
    	<tr>
    		...
    		<td align="center"><a href="<?php echo base_url()?>Administrator/sales"><img style="width:100px;height:100px" src="<?php echo base_url()?>images/dashboard/sell.png" alt=""><br><h3>Sales</h3></a></td>
    	...
    	<tr>
    		...
    		<td align="center"><a href="<?php echo base_url()?>Administrator/login/logout"><img style="width:100px;height:100px" src="<?php echo base_url()?>images/dashboard/logout.png" alt=""><br><h3>Log Out</h3></a></td>
