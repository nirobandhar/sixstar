                    ...
                    <div class="middle_form">
                        ...
                        <div class="body">
                            ...
                            <div class="full clearfix">
                                <span>Company</span>
                                <div class="left">                                      
                                     <input name="company" id="company" type="text" value="<?php echo $selected['company'] ?>"/>
                                </div>
                            </div>
                            <div class="full clearfix">
                            ...
                            <div class="full clearfix">
                                ...
                                <a href="<?php echo base_url();?>Administrator/page/add_category" class="button">Cancel</a>
            ...
            while($row = mysql_fetch_array($sql)){ ?>
                <tr>
                   ...
                   <td style="width:200px"><?php echo $row['ProductCategory_Description'] ?></td>
                    ...
                    <td style="width:90px">
                        <a href="<?php echo base_url().'Administrator/page/catedit/'.$row['ProductCategory_SlNo'];?>" style="color:green;font-size:20px;float:left" title="Eidt" onclick="return confirm('Are you sure you want to edit this item?');"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
    function submit(){
        ...
        var inputdata = 'catname='+catname+'&catdescrip='+catdescrip+'&id='+id+'&company='+company;
