                        ...
                        <div class="middle_form">
                            ...
                            <div class="body">
                                ...
                                <div class="full clearfix">
                                    ...
                                    <div class="left">                                      
                                        <input name="brunchtitle" type="text" id="brunchtitle" class="required" value="<?php echo $selected['Brunch_title'] ?>" />
                                    </div>
                                </div>
                                <div class="full clearfix">
                                    ...
                                    <div class="left">                                      
                                        <select name="" id="Access" class="required" style="width:173px">
                                            <option value="<?php echo $selected['Brunch_sales'] ?>"><?php if($selected['Brunch_sales']==1){echo 'Whole Sales';}else{echo 'Retail Sales';} ?></option>
                                ...
                                <div class="full clearfix">
                                    ...
                                    <div class="left"> 
                                        <textarea name="area1" id="brunchaddress" rows="5" class="required"><?php echo $selected['Brunch_address'] ?></textarea>                                     
                                ...
                                <div class="full clearfix">
                                    <div class="section_right clearfix">
                                        ...
                                        <a href="<?php echo base_url();?>Administrator/page/brunch" class="button">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
