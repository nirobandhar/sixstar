                    ...
                    <div class="body">
                        ...
                        <div class="full clearfix">
                            <div class="left clearfix">
                                <a href="<?php echo base_url();?>Administrator/employee/designation" class="button">Cancel</a>
...
<script type="text/javascript">
    function submit(){
        ...
        var urldata = "<?php echo base_url();?>Administrator/employee/designationupdate";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
