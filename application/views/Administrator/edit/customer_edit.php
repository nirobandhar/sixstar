            ...
            <div id="tabs-1">
                <div class="middle_form">
                    ...
                    <div class="body">
                        ...
                        <div class="full clearfix">
                            ...
                            <div class="left">                                      
                                 <input name="gur_name" type="text" id="gur_name" class="required" autofocus="" style="width:160px" value="<?php echo $selected['Gurantor_Name']; ?>" />
                        ...
                        <div class="full clearfix">
                            ...
                            <div class="left">                                      
                                <input name="gur_contact" type="text" id="gur_contact" class="required" autofocus="" style="width:160px" value="<?php echo $selected['Gurantor_Contact']; ?>" />
                        ...
                        <div class="full clearfix">
                            ...
                            <div class="left">                                      
                                <textarea name="gur_address" rows="3" cols="2" id="gur_address" style="border-color:#C8D3DF;height:70px;width:100%;"><?php echo $selected['Gurantor_Address']; ?></textarea>
                ...
                <div class="right_form">
                    ...
                    <div class="body">
                        ...
                        <div class="full clearfix">
                            <span></span>
                            <a href="<?php echo base_url();?>Administrator/customer" class="button">Cancel</a>
...
<script type="text/javascript">
    function update(){
        ...
        var urldata = "<?php echo base_url();?>Administrator/customer/customerupdate";
        //alert(inputdata);
        $.ajax({
            type: "POST",
            url: urldata,
