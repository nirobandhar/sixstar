            ...
            <div id="tabs-1">
                <div class="middle_form">
                    ...
                    <div class="body">
                        <div class="full clearfix">
                            ...
                            <div class="left">                                    
                                <input name="supplier_id" type="text" id="lier_id" class="required" disabled="" value="<?php echo $selected['Supplier_Code']?>" autofocus="" />
                        ...
                        <div class="full clearfix">
                            <span>Address</span>
                            <div class="left">                                      
                                <textarea name="address" rows="2" cols="2" id="address" style="border-color:#C8D3DF;height:80px;width:100%;"><?php echo $selected['Supplier_Address']?></textarea>
                            </div>
                        </div>
                        <div class="full clearfix">
                            <span>District</span>
                ...
                <div class="right_form">
                    ...
                    <div class="body">
                        ...
                        <div class="full clearfix">
                           <span></span>
                            <!-- <a href="<?php echo base_url();?>Administrator/supplier" class="button" />Cancel</a> -->
                            <input type="button" onClick="window.location='<?php echo base_url();?>Administrator/supplier'" value="Cancel" class="button" />
