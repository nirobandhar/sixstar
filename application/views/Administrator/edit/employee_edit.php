...
<div class="content_scroll">
    ...
    <div id="page_menu" class="page_menu">
        ...
        <ul>
            ...
            <li class="active"><a href="<?php echo base_url();?>Administrator/employee">Edit Employee</a></li>

            <li><a href="<?php echo base_url();?>Administrator/employee/emplists">Employee List </a> </li>
                ...
                <form  method="post" enctype="multipart/form-data">
                    ...
                    <div class="middle_form">
                        ...
                        <div class="body">
                            ...
                            <div class="full clearfix">
                                ...
                                <input name="religion" type="text" value="<?php echo $selected['religion']?>" id="religion"/>
							...
							<div class="full clearfix">
                                ...
                                <input name="national" type="text" value="<?php echo $selected['nationality']?>" id="national" />
                            ...
                            <div class="full clearfix">
                                ...
                                <input name="nid" type="text" value="<?php echo $selected['Employee_NID']?>" id="nid"/>
                            ...
                            <div class="full clearfix">
                                ...
                                <input name="bp" type="text" value="<?php echo $selected['bloodgrp']?>" id="bp" />
                            ...
                            <div class="full clearfix">
                                ...
                                <input name="height" type="text" value="<?php echo $selected['height']?>" id="height" class="required"  />
                    ...
                    <div class="right_form">
                        ...
                        <div class="body">
							...
							<div class="full clearfix">
                                ...
                                <span>Notes</span>
								<textarea name="notes"  id="notes" cols="50" rows="4"><?php echo $selected['notes']?></textarea>
                    ...
                    <div class="section_content">
                        ...
                        <div class="section_right clearfix">
                           ...
                           <a  class="button btn-info"  href="<?php echo base_url();?>Administrator/employee/emplists">Cancel</a>
    ...
    function Employee_submit(){
        ...
        var fd = new FormData();
          ...
          var x = $.ajax({
            ...
            url: "<?php echo base_url();?>Administrator/employee/employee_Update/",
