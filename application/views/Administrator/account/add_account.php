                    ...
                    <div class="middle_form">
                        <div class="body">
                            <div class="full clearfix">
                                ...
                                <div class="left">                                    
                                    <input name="supplier_id" type="text" id="lier_id" class="required" disabled="" value="<?php   $serial ="A1000"; $sql = mysql_query("SELECT * FROM tbl_account");
                                    ...
                                    <input name="account_id" type="hidden" id="account_id" class="required" value="<?php   $serial ="A1000"; $sql = mysql_query("SELECT * FROM tbl_account");
                                        while ($d = mysql_fetch_array($sql)){
                                            if($d['Acc_Code']!=null){$serial = $d['Acc_Code'];}
                                        } $serial = explode("A",$serial);
                                            $serial=$serial['1']; $autoserial= $serial+1;echo "A".$autoserial;?>" autofocus="" />
...
<script type="text/javascript">
    function submit(){
        ...
        var urldata = "<?php echo base_url();?>Administrator/account/account_insert";
        //alert(inputdata);
        $.ajax({
            type: "POST",
            url: urldata,
...
<script type="text/javascript">
       function Updatesubmit(){
        ...
        var urldata = "<?php echo base_url();?>Administrator/account/account_update";
        //alert(inputdata);
        $.ajax({
            type: "POST",
            url: urldata,
...
<script type="text/javascript">
    function Edit_Account(id){
        ...
        var urldata = "<?php echo base_url();?>Administrator/account/account_edit";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
...
<script type="text/javascript">
    function deleted(id){
        ...
        //alert(inputdata);
        var urldata = "<?php echo base_url();?>Administrator/account/account_delete";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
