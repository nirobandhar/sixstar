...
<link href="<?php echo base_url()?>css/prints.css" rel="stylesheet" />
    ...
    <table class="border" cellspacing="0" cellpadding="0" width="80%">
        ...
        <h4><a style="cursor:pointer" onclick="window.open('<?php echo base_url(); ?>Administrator/reports/summery_print', 'newwindow', 'width=850, height=800,scrollbars=yes'); return false;"><img src="<?php echo base_url(); ?>images/printer.png" alt=""> Print</a></h4>
        <tr bgcolor="#ccc">
            <th>Sales</th> 
