                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select name="" id="accountid" class="inputclass" style="width:200px" onchange="Supplierdata()">
                                            ...
                                            <?php $sql = mysql_query("SELECT * FROM tbl_account order by Acc_Name desc");
...
<script type="text/javascript">
    ...
    function searchforRecord(){
        ...
        var urldata = "<?php echo base_url();?>Administrator/account/expense_search";
...
<script type="text/javascript">
    ...
    function Selected(){
        ...
        if(searchtype == "Account"){
            ...
            $("#showcustomer").show();
			$("#accountid_chosen").css({"width":"200px"});
