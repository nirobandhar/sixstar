        ...
        <table class="zebra" cellspacing="0" cellpadding="0" border="0" id="" style="text-align:left;width:100%;">
            ...
            while($row = mysql_fetch_array($sql)){ ?>
                <tr>
                    ...
                    <td style="width:90px">
                        <a href="<?php echo base_url().'Administrator/employee/employee_edit/'.$row['Employee_SlNo'];?>" style="color:green;font-size:20px;float:left" title="Eidt" onclick="return confirm('Are you sure you want to Edit this item?');"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
    function deleted(id){
        ...
        //alert(inputdata);
        var urldata = "<?php echo base_url();?>Administrator/employee/employee_Delete";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
