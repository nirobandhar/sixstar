...
$sql = mysql_query("SELECT tbl_menuaccess.*, tbl_user.* FROM tbl_menuaccess left join tbl_user on tbl_user.User_SlNo = tbl_menuaccess.branch_id WHERE tbl_menuaccess.branch_id = '$bid'");
$row = mysql_fetch_array($sql); ?>
    <h1 style="background:#ddd;" align="center"><?php echo $row['FullName'] ?> Permission</h1>
    <form action="<?php echo base_url() ?>Administrator/branch/Shahbag_Insert" method="post">
            ...
            <ul id="brunch_menu">
                ...
                <li><INPUT TYPE="CHECKBOX" <?php if($row['Sales']==1)echo "checked";?> value="<?php echo $row['Sales'];?>" id="Sales" NAME="Sales">Sales
                    <ul id="brunch_menu">
                        ...
                        <li><INPUT TYPE="CHECKBOX" <?php if($row['installment']==1)echo "checked";?> value="<?php echo $row['installment'];?>" id="insSales" NAME="insSales">Installment Sale</li>
                    </ul>
                </li>
            ...
            <ul id="brunch_menu">
                ...
                <li><INPUT TYPE="CHECKBOX" <?php if($row['rpSales']==1)echo "checked";?> value="<?php echo $row['rpSales'];?>" id="RSales" NAME="RSales">Sales
                    <ul id="brunch_menu">
                        ...
                        <li><INPUT TYPE="CHECKBOX" <?php if($row['installment_record']==1)echo "checked";?> value="<?php echo $row['installment_record'];?>" id="insRecord" NAME="insRecord">Installment Record</li>
                ...
                <li><INPUT TYPE="CHECKBOX" <?php if($row['rpAccounts']==1)echo "checked";?> value="<?php echo $row['rpAccounts'];?>" id="RAccounts" NAME="RAccounts">Accounts
                    <ul id="brunch_menu">
                        ...
                        <li><INPUT TYPE="CHECKBOX" <?php if($row['monthlysummery']==1)echo "checked";?> value="<?php echo $row['monthlysummery'];?>" id="summery" NAME="summery">Monthly Summery</li>
                        <li><INPUT TYPE="CHECKBOX" <?php if($row['lossprofit']==1)echo "checked";?> value="<?php echo $row['lossprofit'];?>" id="prolos" NAME="prolos">Profit/Loss</li>
                    </ul>
                </li>
...
<script language="javascript">
    $(document).ready(function(){
		...
		$("#insSales").on('click',function(){
            var insSales = $("#insSales").is(":checked");
            if(insSales){
                $("#insSales").val('1');
            }else{
                $("#insSales").val('0');
		...
		$("#insRecord").on('click',function(){
            var insRecord = $("#insRecord").is(":checked");
            if(insRecord){
                $("#insRecord").val('1');
            }else{
                $("#insRecord").val('0');
		...
		$("#summery").on('click',function(){
            var summery = $("#summery").is(":checked");
            if(summery){
                $("#summery").val('1');
            }else{
                $("#summery").val('0');
		...
		$("#prolos").on('click',function(){
            var prolos = $("#prolos").is(":checked");
            if(prolos){
                $("#prolos").val('1');
            }else{
                $("#prolos").val('0');
