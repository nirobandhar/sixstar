...
<script type="text/javascript">
    ...
    function submit(){
        ...
        var urldata = "<?php echo base_url();?>Administrator/package/package_create_Insert";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
    ...
    function update(){
        ...
        var urldata = "<?php echo base_url();?>Administrator/package/createUdate";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
    ...
    function deleted(id){
        ...
        //alert(inputdata);
        var urldata = "<?php echo base_url();?>Administrator/package/createDelete";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
    ...
    function packageEdit(id){
        ...
        var urldata = "<?php echo base_url();?>Administrator/package/createEdit";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
