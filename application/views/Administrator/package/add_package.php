...
<script type="text/javascript">
    function submit(){
        ...
        var urldata = "<?php echo base_url();?>Administrator/package/package_Insert";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
    ...
    function update(){
        ...
        var urldata = "<?php echo base_url();?>Administrator/package/packageUdate";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
...
<script type="text/javascript">
    function deleted(id){
        ...
        //alert(inputdata);
        var urldata = "<?php echo base_url();?>Administrator/package/packageDelete";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
    ...
    function packageEdit(id){
        ...
        //alert(inputdata);
        var urldata = "<?php echo base_url();?>Administrator/package/packageEdit";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
