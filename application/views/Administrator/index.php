        ...
        <header>
            ...
            <div class="status_bar">
                ...
                <!-- <section>
                    ...
                    <a class="help"  title="Settings">

                        <i></i>

                        <span>Branch Menu</span>
                    ...
                    <div class="dropdown">
                        ...
                        <?php $sql = mysql_query("SELECT * FROM tbl_user");

                        while($raw = mysql_fetch_array($sql)){ ?>

                            <li><a href='<?php echo base_url();?>Administrator/branch/setting/<?php echo $raw['User_SlNo']; ?>'><span><?php echo $raw['FullName']; ?></span></a></li>
                ...
                <section>
                    ...
                    <div class="dropdown">
                        ...
                        <ul>
                            ...
                            <li><a href='<?php echo base_url();?>Administrator/page/add_category'><span>Add Category</span></a></li>
                ...
                <section>
                    ...
                    <div class="dropdown profile">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo base_url();?>Administrator/user_management">User Management</a></li>

                            <li><a href="<?php echo base_url();?>Administrator/login/logout">Log out</a></li>
