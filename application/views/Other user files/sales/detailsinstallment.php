...
<table class="border" cellspacing="0" cellpadding="0" width="95%">
        <h4><a style="cursor:pointer" onclick="window.open('<?php echo base_url();?>reports/installmentrecord?std=<?php echo $startdate;?>&ltd=<?php echo $enddate;?>', 'newwindow', 'width=850, height=800,scrollbars=yes'); return false;"><img src="<?php echo base_url(); ?>images/printer.png" alt=""> Print</a></h4>
        <tr bgcolor="#89B03E">
            <th>SI</th>
            <th>Customer Name</th>
