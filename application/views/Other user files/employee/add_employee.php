<div class="content_scroll">
    ...
    <div id="page_menu" class="page_menu">
        ...
        <?php $branchide = $this->session->userdata('BRANCHid'); 

        $sqle = mysql_query("SELECT * FROM tbl_menuaccess WHERE branch_id= '$branchide'");

        $rowe = mysql_fetch_array($sqle); if($rowe['Add_Employee'] == 1){?>

            <li class="active"><a href="<?php echo base_url() ?>employee">Add Employee</a></li>

            <?php }if($rowe['Employee_List'] == 1){?>
                    ...
                    <div class="middle_form">
                        ...
                        <div class="body">
                            ...
                            <div class="full clearfix">
                                ...
                                $rowe = mysql_fetch_array($sqle); if($rowe['Add_Department'] == 1){?>
