            ...
            <?php $sql = mysql_query("SELECT * FROM tbl_country order by CountryName asc");
                ...
                <tr>
                    ...
                    <td style="width:90px">
                       ...
                       <a href="<?php echo base_url().'page/countryedit/'.$row['Country_SlNo'];?>" style="color:green;font-size:20px;float:left; margin-right:20px;" title="Eidt" onclick="return confirm('Are you sure you want to Edit this item?');"><i class="fa fa-pencil"></i></a>
