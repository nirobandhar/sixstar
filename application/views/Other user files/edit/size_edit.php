                    ...
                    <div class="middle_form">
                        ...
                        <div class="body">
                            ...
                            <div class="full clearfix">
                                ...
                                <a href="<?php echo base_url();?>page/add_size" class="button">Cancel</a>
        ...
        <table class="zebra" cellspacing="0" cellpadding="0" border="0" id="" style="text-align:left;width:100%;border-collapse:collapse;">
            ...
            while($row = mysql_fetch_array($sql)){ ?>
                <tr>
                    ...
                    <td style="width:90px">
                        <a href="<?php echo base_url().'page/sizedit/'.$row['Productsize_SlNo'];?>" style="color:green;font-size:20px;float:left" title="Eidt" onclick="return confirm('Are you sure you want to Edit this item?');"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
    function submit(){
        ...
        var urldata = "<?php echo base_url();?>page/sizeupdate";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
...
<script type="text/javascript">
    function deleted(id){
        ...
        //alert(inputdata);
        var urldata = "<?php echo base_url();?>page/sizedelete";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
