...
<div class="content_scroll">
    <div id="page_menu" class="page_menu">
        ...
        <a class="button" href="<?php echo base_url();?>user_management/add_user" title="Add New">Add User</a>
        ...
        <table class="zebra" cellspacing="0" cellpadding="0" border="0" id="" style="width:60%;border-collapse:collapse;">
            <thead>
                <tr class="header">
                    ...
                    <th scope="col" style="width:160px;">Branch</th>
            ...
            <?php $i=""; $sql = mysql_query("SELECT tbl_user.*,tbl_brunch.* FROM tbl_user left join tbl_brunch on tbl_brunch.brunch_id=tbl_user.userBrunch_id");while($row = mysql_fetch_array($sql)){ $i++; ?>
                <tr class="item">
                    ...
                    <td>
                        <a href="<?php echo base_url().'user_management/edit/'.$row['User_SlNo'];?>" style="color:green;font-size:25px;float:left; margin-right:20px;" title="Eidt" onclick="return confirm('Are you sure you want to edit this item?');"><i class="fa fa-pencil"></i></a>
