            ...
            <table width="100%"> 
                <tr>
                    ...
                    <div class="full clearfix">
                        <input type="text" class="inputclass" disabled="" style="width:200px" value="<?php $serial =date("Y-m-d").'0001'; $sql = mysql_query("SELECT * FROM tbl_purchasemaster");
                        ...
                        <table class="purchestable"> 
                            ...
                            <tr>
                             <?php $k=0;
								...
								$k++;
		 						?>
                                <td style="float:left;"><div class="full clearfix"><?php echo $rowbr['Brunch_name'];?><input name="<?php echo $rowbr['Brunch_name'];?>" class="test" type="checkbox" value="<?php echo $k;?>" id="godown<?php echo $k;?>" /><input name="geti" id="chkb<?php echo $k;?>" type="hidden" value="<?php echo $rowbr['brunch_id'];?>" /></div></td>
                    ...
                    <tr>
                        <td width="40%" >
                            <fieldset style="height:135px">
                                <legend>Notes</legend>
                                <textarea name="PurchNotes" id="PurchNotes" rows="4" style="width:100%"></textarea>
                            </fieldset>
                        </td>
                        <td width="60%">
        ...
        <fieldset>
            ...
            <table width="100%"> 
                ...
                <tr>
                    ...
                    <input type="button" class="buttonAshiqe" onclick="window.location = '<?php echo base_url();?>purchase'" value="New Purchase"></td>
                    </td>
                </tr>
            </table>
        </fieldset>
...
<script type="text/javascript">
    function ProductPurchase(){
        ...
        var inputdata = 'packagename='+packagename+'&purchInvoice='+purchInvoice+'&Purchase_date='+Purchase_date+'&SupplierID='+SupplierID+'&subTotal='+subTotal+'&vatPersent='+vatPersent+'&purchFreight='+purchFreight+'&purchDiscount='+purchDiscount+'&purchTotal='+purchTotal+'&PurchPaid='+PurchPaid+'&purchaseDue='+purchaseDue+'&Notes='+Notes;
